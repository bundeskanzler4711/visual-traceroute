...
/**
 * Class is currently not in use, you can use it to put Markers on the Earth.
 * <p>
 * Use like:
 * <p>
 * setup(): Coordinate greenwhich = new Coordinate(51, "W", 1, "E"); Coordinate san_francisco = new Coordinate(37, "N",
 * 122, "W"); Coordinate athen = new Coordinate(37, "N", 23, "E");
 * <p>
 * draw(): Marker.drawMarker(this, greenwhich);
 * @author michi
 */
